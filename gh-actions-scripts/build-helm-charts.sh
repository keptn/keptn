...
helm install --dry-run --debug "keptn-charts/keptn-${VERSION}.tgz"
...
helm install --dry-run --debug "keptn-charts/helm-service-${VERSION}.tgz" > out.yml
...
helm install --dry-run --debug "keptn-charts/jmeter-service-${VERSION}.tgz"
