...
func printQuickAccessInstructionsForUnix(keptnNamespace, keptnReleaseDocsURL string) {
...
func printQuickAccessInstructionsForWindows(keptnNamespace string, keptnReleaseDocsURL string) {
