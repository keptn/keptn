...
gcloud beta container --project "$PROJECT_NAME" clusters create "$CLUSTER_NAME_NIGHTLY" --zone "$CLOUDSDK_COMPUTE_ZONE" \
 ...
 --network "projects/$PROJECT_NAME/global/networks/default" --subnetwork "projects/$PROJECT_NAME/regions/$CLOUDSDK_REGION/subnetworks/default" \
