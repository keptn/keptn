...
func Test_GKE(t *testing.T) {
	...
	t.Run("TestSequenceQueue", TestSequenceQueue)
	t.Run("TestSequenceQueue_TriggerMultiple", TestSequenceQueue_TriggerMultiple)
	t.Run("TestSequenceQueue_TriggerAndDeleteProject", TestSequenceQueue_TriggerAndDeleteProject)
