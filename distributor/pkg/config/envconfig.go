...
type EnvConfig struct {
	...
	MaxHeartBeatRetries       int           `envconfig:"MAX_HEARTBEAT_RETRIES" default:"5"`
	MaxRegistrationRetries    int           `envconfig:"MAX_REGISTRATION_RETRIES" default:"5"`
	HeartbeatIntervalDuration time.Duration `envconfig:"HEARTBEAT_INTERVAL_DURATION" default:"10s"`
