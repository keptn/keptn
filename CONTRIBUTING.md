...
* *end-to-end tests* (integration tests) - run automatically once per day (see [test/](test/) for details). To run them, please see the documentation [here](https://github.com/keptn/keptn/blob/master/docs/developer/integration_tests.md).
