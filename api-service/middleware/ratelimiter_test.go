...
import (
	...
	middleware_mock "github.com/keptn/keptn/api-service/middleware/fake"
...
func TestRateLimiter(t *testing.T) {
	...
	tokenValidator := &middleware_mock.TokenValidatorMock{ValidateTokenFunc: func(token string) (*model.Principal, error) {
	...
	tokenValidator.ValidateTokenFunc = func(token string) (*model.Principal, error) {
		return nil, nil
	}
	req, err = http.NewRequest(http.MethodGet, "", nil)
	require.Nil(t, err)
