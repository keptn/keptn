...
func (o *TriggerEvaluationURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on TriggerEvaluationURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on TriggerEvaluationURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on TriggerEvaluationURL")
	}
...
func (o *TriggerEvaluationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on TriggerEvaluationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on TriggerEvaluationURL")
	}
