...
func (o *DeleteProjectProjectNameURL) WithBasePath(bp string) *DeleteProjectProjectNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteProjectProjectNameURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on DeleteProjectProjectNameURL")
	}
...
func (o *DeleteProjectProjectNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectProjectNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectProjectNameURL")
	}
