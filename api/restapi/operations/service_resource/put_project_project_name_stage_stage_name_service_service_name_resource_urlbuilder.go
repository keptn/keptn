...
func (o *PutProjectProjectNameStageStageNameServiceServiceNameResourceURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PutProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on PutProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
...
func (o *PutProjectProjectNameStageStageNameServiceServiceNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
