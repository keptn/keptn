...
app.kubernetes.io/version: {{ include "service.tag" ( dict "imageRoot" .Values.global.keptn "global" .Values.global.keptn "defaultTag" .Chart.AppVersion) }}
...
- name: DISTRIBUTOR_VERSION
  value: {{ include "service.tag" ( dict "imageRoot" .Values.distributor.image "global" .Values.global.keptn "defaultTag" .Chart.AppVersion) }}
- name: LOCATION
  valueFrom:
   fieldRef:
