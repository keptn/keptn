...
kubectl delete -f https://github.com/knative/build/releases/download/v0.5.0/build.yaml
kubectl delete -f https://github.com/knative/eventing/releases/download/v0.5.0/release.yaml
kubectl delete -f https://github.com/knative/eventing-sources/releases/download/v0.5.0/eventing-sources.yaml
kubectl delete -f https://github.com/knative/serving/releases/download/v0.5.0/monitoring.yaml
kubectl delete -f https://raw.githubusercontent.com/knative/serving/v0.5.0/third_party/config/build/clusterrole.yaml
