...
print_info "KNOWN ISSUE: Applying the knative v.0.5.0 release.yaml runs into a race condition for the custom resource definition ClusterChannelProvisioner. This does not have an impact on keptn." 
...
## (!) Two pods in knative-monitoring do not run.
print_info "KNOWN ISSUE: Two pods in knative-monitoring do not run."
