...
// PostProjectProjectNameStageStageNameResourceParams contains all the bound params for the post project project name stage stage name resource operation
...
func (o *PostProjectProjectNameStageStageNameResourceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body PostProjectProjectNameStageStageNameResourceBody
...
func (o *PostProjectProjectNameStageStageNameResourceParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostProjectProjectNameStageStageNameResourceParams) bindStageName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
