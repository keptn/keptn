...
// NewGetProjectProjectNameStageStageNameResourceResourceURIParams creates a new GetProjectProjectNameStageStageNameResourceResourceURIParams object
...
func NewGetProjectProjectNameStageStageNameResourceResourceURIParams() GetProjectProjectNameStageStageNameResourceResourceURIParams {
	...
	return GetProjectProjectNameStageStageNameResourceResourceURIParams{
		DisableUpstreamSync: &disableUpstreamSyncDefault,
	}
}

// GetProjectProjectNameStageStageNameResourceResourceURIParams contains all the bound params for the get project project name stage stage name resource resource URI operation
...
func (o *GetProjectProjectNameStageStageNameResourceResourceURIParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetProjectProjectNameStageStageNameResourceResourceURIParams) bindDisableUpstreamSync(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetProjectProjectNameStageStageNameResourceResourceURIParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetProjectProjectNameStageStageNameResourceResourceURIParams) bindResourceURI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetProjectProjectNameStageStageNameResourceResourceURIParams) bindStageName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
