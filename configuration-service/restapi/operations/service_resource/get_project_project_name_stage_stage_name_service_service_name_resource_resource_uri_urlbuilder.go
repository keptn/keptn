...
func (o *GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
...
func (o *GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectProjectNameStageStageNameServiceServiceNameResourceResourceURIURL")
	}
