...
// PostProjectProjectNameStageStageNameServiceServiceNameResourceParams contains all the bound params for the post project project name stage stage name service service name resource operation
...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body PostProjectProjectNameStageStageNameServiceServiceNameResourceBody
...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceParams) bindServiceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceParams) bindStageName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
