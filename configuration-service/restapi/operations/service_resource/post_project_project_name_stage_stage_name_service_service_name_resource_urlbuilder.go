...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PostProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PostProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on PostProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
...
func (o *PostProjectProjectNameStageStageNameServiceServiceNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostProjectProjectNameStageStageNameServiceServiceNameResourceURL")
	}
