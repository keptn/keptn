...
// PostProjectProjectNameStageParams contains all the bound params for the post project project name stage operation
...
func (o *PostProjectProjectNameStageParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
