...
// NewGetProjectProjectNameParams creates a new GetProjectProjectNameParams object
// no default values defined in spec.
func NewGetProjectProjectNameParams() GetProjectProjectNameParams {

	return GetProjectProjectNameParams{}
}

// GetProjectProjectNameParams contains all the bound params for the get project project name operation
...
func (o *GetProjectProjectNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetProjectProjectNameParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
