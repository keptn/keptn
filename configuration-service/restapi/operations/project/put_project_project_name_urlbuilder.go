...
func (o *PutProjectProjectNameURL) WithBasePath(bp string) *PutProjectProjectNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutProjectProjectNameURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameURL")
	}
...
func (o *PutProjectProjectNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameURL")
	}
