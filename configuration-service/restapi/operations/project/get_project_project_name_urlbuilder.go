...
func (o *GetProjectProjectNameURL) WithBasePath(bp string) *GetProjectProjectNameURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetProjectProjectNameURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on GetProjectProjectNameURL")
	}
...
func (o *GetProjectProjectNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectProjectNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectProjectNameURL")
	}
