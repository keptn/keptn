...
func (o *PutProjectProjectNameResourceURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameResourceURL")
	}
...
func (o *PutProjectProjectNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameResourceURL")
	}
