...
func (o *GetProjectProjectNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on GetProjectProjectNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on GetProjectProjectNameResourceResourceURIURL")
	}
...
func (o *GetProjectProjectNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectProjectNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectProjectNameResourceResourceURIURL")
	}
