...
// NewGetProjectProjectNameResourceResourceURIParams creates a new GetProjectProjectNameResourceResourceURIParams object
...
// GetProjectProjectNameResourceResourceURIParams contains all the bound params for the get project project name resource resource URI operation
...
func (o *GetProjectProjectNameResourceResourceURIParams) bindDisableUpstreamSync(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetProjectProjectNameResourceResourceURIParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetProjectProjectNameResourceResourceURIParams) bindResourceURI(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
