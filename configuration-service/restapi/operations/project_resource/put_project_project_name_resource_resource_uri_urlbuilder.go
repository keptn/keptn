...
func (o *PutProjectProjectNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on PutProjectProjectNameResourceResourceURIURL")
	}
...
func (o *PutProjectProjectNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameResourceResourceURIURL")
	}
