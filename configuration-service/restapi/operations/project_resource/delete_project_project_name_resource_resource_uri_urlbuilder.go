...
func (o *DeleteProjectProjectNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	var _path = "/project/{projectName}/resource/{resourceURI}"

	projectName := o.ProjectName
	if projectName != "" {
		_path = strings.Replace(_path, "{projectName}", projectName, -1)
	} else {
		return nil, errors.New("projectName is required on DeleteProjectProjectNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on DeleteProjectProjectNameResourceResourceURIURL")
	}
...
func (o *DeleteProjectProjectNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectProjectNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectProjectNameResourceResourceURIURL")
	}
