...
func (o *PutProjectProjectNameServiceServiceNameResourceURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameServiceServiceNameResourceURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PutProjectProjectNameServiceServiceNameResourceURL")
	}
...
func (o *PutProjectProjectNameServiceServiceNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameServiceServiceNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameServiceServiceNameResourceURL")
	}
