...
func (o *GetProjectProjectNameServiceServiceNameResourceURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on GetProjectProjectNameServiceServiceNameResourceURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on GetProjectProjectNameServiceServiceNameResourceURL")
	}
...
func (o *GetProjectProjectNameServiceServiceNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetProjectProjectNameServiceServiceNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetProjectProjectNameServiceServiceNameResourceURL")
	}
