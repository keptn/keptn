...
func (o *PostProjectProjectNameServiceServiceNameResourceURL) Build() (*url.URL, error) {
	...
	var _path = "/project/{projectName}/service/{serviceName}/resource"

	projectName := o.ProjectName
	if projectName != "" {
		_path = strings.Replace(_path, "{projectName}", projectName, -1)
	} else {
		return nil, errors.New("projectName is required on PostProjectProjectNameServiceServiceNameResourceURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PostProjectProjectNameServiceServiceNameResourceURL")
	}
...
func (o *PostProjectProjectNameServiceServiceNameResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostProjectProjectNameServiceServiceNameResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostProjectProjectNameServiceServiceNameResourceURL")
	}
