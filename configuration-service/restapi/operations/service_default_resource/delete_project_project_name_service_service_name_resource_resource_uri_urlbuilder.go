...
func (o *DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
...
func (o *DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
