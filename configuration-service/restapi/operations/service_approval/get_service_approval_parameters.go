...
// NewGetServiceApprovalParams creates a new GetServiceApprovalParams object
// with the default values initialized.
func NewGetServiceApprovalParams() GetServiceApprovalParams {
	...
	return GetServiceApprovalParams{
		PageSize: &pageSizeDefault,
	}
}

// GetServiceApprovalParams contains all the bound params for the get service approval operation
// typically these are obtained from a http.Request
//
// swagger:parameters getServiceApproval
type GetServiceApprovalParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetServiceApprovalParams() beforehand.
func (o *GetServiceApprovalParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetServiceApprovalParams) bindApprovalID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetServiceApprovalParams) bindNextPageKey(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServiceApprovalParams) bindPageSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	// AllowEmptyValue: false
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetServiceApprovalParams()
		return nil
	}
...
func (o *GetServiceApprovalParams) validatePageSize(formats strfmt.Registry) error {
...
func (o *GetServiceApprovalParams) bindProjectName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServiceApprovalParams) bindServiceName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetServiceApprovalParams) bindStageName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
