...
func (o *PutProjectProjectNameStageStageNameServiceServiceNameURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PutProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on PutProjectProjectNameStageStageNameServiceServiceNameURL")
	}
...
func (o *PutProjectProjectNameStageStageNameServiceServiceNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameStageStageNameServiceServiceNameURL")
	}
