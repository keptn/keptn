...
func (o *PostProjectProjectNameStageStageNameServiceURL) Build() (*url.URL, error) {
	...
	var _path = "/project/{projectName}/stage/{stageName}/service"

	projectName := o.ProjectName
	if projectName != "" {
		_path = strings.Replace(_path, "{projectName}", projectName, -1)
	} else {
		return nil, errors.New("projectName is required on PostProjectProjectNameStageStageNameServiceURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on PostProjectProjectNameStageStageNameServiceURL")
	}
...
func (o *PostProjectProjectNameStageStageNameServiceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostProjectProjectNameStageStageNameServiceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostProjectProjectNameStageStageNameServiceURL")
	}
