...
Create `jmeter-service/chart/values-local.yaml` file for your local values to be stored. The file should look like this:
For local templating use `helm template . -f values-local.yaml --name-template test-jmeter-service --output-dir ../../temp`
