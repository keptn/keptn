...
func (o *DeleteProjectProjectNameStageStageNameServiceServiceNameURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on DeleteProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on DeleteProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	...
	if stageName != "" {
		...
		return nil, errors.New("stageName is required on DeleteProjectProjectNameStageStageNameServiceServiceNameURL")
	}
...
func (o *DeleteProjectProjectNameStageStageNameServiceServiceNameURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectProjectNameStageStageNameServiceServiceNameURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectProjectNameStageStageNameServiceServiceNameURL")
	}
