...
func (o *PutProjectProjectNameServiceServiceNameResourceResourceURIURL) Build() (*url.URL, error) {
	...
	if projectName != "" {
		...
		return nil, errors.New("projectName is required on PutProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if resourceURI != "" {
		...
		return nil, errors.New("resourceUri is required on PutProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	...
	if serviceName != "" {
		...
		return nil, errors.New("serviceName is required on PutProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
...
func (o *PutProjectProjectNameServiceServiceNameResourceResourceURIURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutProjectProjectNameServiceServiceNameResourceResourceURIURL")
	}
