...
func TestUpdateProject(t *testing.T) {
	...
	examplePayload := `{"gitCredentials":{"remoteURL":"http://remote-url.com", "mode":"https", "user":"gituser", "https":{"token":"99c4c193-4813-43c5-864f-ad6f12ac1d82"}},"name":"myproject"}`
