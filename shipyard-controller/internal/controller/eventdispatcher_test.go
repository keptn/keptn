...
func Test_WhenSyncTimeElapses_EventsAreDispatched(t *testing.T) {
	...
	eventRepo.GetEventsFunc = func(project string, filter common.EventFilter, status ...common.EventStatus) ([]apimodels.KeptnContextExtendedCE, error) {
		return []apimodels.KeptnContextExtendedCE{{Shkeptncontext: "my-context", ID: *filter.ID, Specversion: "1.0", Source: common.Stringp("source"), Type: common.Stringp("my-type"), Data: keptnv2.EventData{
			Project: "my-project",
			Stage:   "my-stage",
			Service: "my-service",
		}}}, nil
