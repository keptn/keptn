...
type ISequenceDispatcher interface {
	...
	Run(ctx context.Context, mode common.SDMode, startSequenceFunc func(event keptnmodels.KeptnContextExtendedCE) error)
...
type SequenceDispatcher struct {
	...
	startSequenceFunc     func(event keptnmodels.KeptnContextExtendedCE) error
...
func (sd *SequenceDispatcher) SetStartSequenceCallback(startSequenceFunc func(event keptnmodels.KeptnContextExtendedCE) error) {
	sd.startSequenceFunc = startSequenceFunc
}

func (sd *SequenceDispatcher) Run(ctx context.Context, mode common.SDMode, startSequenceFunc func(event keptnmodels.KeptnContextExtendedCE) error) {
