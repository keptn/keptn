...
func (sc *shipyardController) forceTaskSequenceCompletion(sequenceTriggeredEvent apimodels.KeptnContextExtendedCE, sequenceExecution models.SequenceExecution) error {
