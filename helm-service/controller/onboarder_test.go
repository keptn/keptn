...
//func newTestOnboardHandlerCreator(t *testing.T, mockedBaseHandlerOptions ...MockedHandlerOption) (*gomock.Controller, Onboarder, mocksCollection) {
//
...
//	}
//
//	ctrl, instance, moqs := newTestOnboardHandlerCreator(t, opt)
//	defer ctrl.Finish()
//
//	stages := []*models.Stage{{Services: []*models.Service{{}}, StageName: "dev"}}
//
...
//	ctrl, instance, mocksCol := newTestOnboardHandlerCreator(t)
//	defer ctrl.Finish()
//
//	testChart := createChart()
//
