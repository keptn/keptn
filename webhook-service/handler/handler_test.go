...
func Test_HandleIncomingTriggeredEvent(t *testing.T) {
	...
	require.Eventually(t, func() bool { return len(curlExecutorMock.CurlCalls()) == 1 }, time.Second, time.Millisecond*10)
	...
	fakeKeptn.AssertSentEvent(t, 0, func(e models.KeptnContextExtendedCE) bool {
		return keptnv2.GetStartedEventType("webhook") == *e.Type
	})
	fakeKeptn.AssertSentEvent(t, 1, func(e models.KeptnContextExtendedCE) bool {
		return keptnv2.GetFinishedEventType("webhook") == *e.Type
	})

	fakeKeptn.AssertSentEvent(t, 1, func(e models.KeptnContextExtendedCE) bool {
		eventData := &keptnv2.EventData{}
		keptnv2.EventDataAs(e, eventData)
		return eventData.Status == keptnv2.StatusSucceeded && eventData.Result == keptnv2.ResultPass
	})
}
...
func Test_HandleIncomingTriggeredEvent_SendMultipleRequests(t *testing.T) {
	...
	require.Eventually(t, func() bool { return len(curlExecutorMock.CurlCalls()) == 2 }, time.Second, time.Millisecond*10)
	require.Eventually(t, func() bool {
		return curlExecutorMock.CurlCalls()[0].CurlCmd == "curl http://local:8080 myproject my-secret-value"
	}, time.Second, time.Millisecond*10)
	require.Eventually(t, func() bool {
		return curlExecutorMock.CurlCalls()[1].CurlCmd == "curl http://local:8080 myproject my-secret-value"
	}, time.Second, time.Millisecond*10)
...
func Test_HandleIncomingTriggeredEvent_SendMultipleRequestsDisableFinished(t *testing.T) {
	...
	require.Eventually(t, func() bool { return len(curlExecutorMock.CurlCalls()) == 4 }, time.Second, time.Millisecond*10)
...
func Test_HandleIncomingTriggeredEvent_NoMatchingWebhookFound(t *testing.T) {
	...
	require.Eventually(t, func() bool { return len(curlExecutorMock.CurlCalls()) == 0 }, time.Second, time.Millisecond*10)
	...
	fakeKeptn.AssertSentEvent(t, 1, func(e models.KeptnContextExtendedCE) bool {
		eventData := &keptnv2.EventData{}
		keptnv2.EventDataAs(e, eventData)
		return eventData.Status == keptnv2.StatusErrored && eventData.Result == keptnv2.ResultFailed
	})
}
