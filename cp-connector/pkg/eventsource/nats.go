...
type EventSource interface {
	...
	Start(context.Context, types.RegistrationData, chan types.EventUpdate, chan error) error
...
func (n *NATSEventSource) Start(ctx context.Context, registrationData types.RegistrationData, eventChannel chan types.EventUpdate, errChan chan error) error {
