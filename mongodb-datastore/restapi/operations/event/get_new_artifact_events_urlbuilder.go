...
func (o *GetNewArtifactEventsURL) WithBasePath(bp string) *GetNewArtifactEventsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetNewArtifactEventsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNewArtifactEventsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNewArtifactEventsURL")
	}
