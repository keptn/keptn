import {
  DevCartsDbLatestServiceEvent,
  DevCartsLatestServiceEvent,
  ProductionCartsDbLatestServiceEvent,
...
const sequencesResponses = {
  ...
  [DevCartsDbLatestServiceEvent.keptnContext]: {
    states: [
      {
  ...
  [StagingCartsLatestServiceEvent.keptnContext]: {
    states: [
      {
        name: 'delivery',
        service: 'carts',
  ...
  [StagingCartsDbLatestServiceEvent.keptnContext]: {
    states: [
      {
        name: 'delivery-direct',
        service: 'carts-db',
  ...
  [ProductionCartsLatestServiceEvent.keptnContext]: {
    states: [
      {
        name: 'remediation',
  ...
  [ProductionCartsDbLatestServiceEvent.keptnContext]: {
    states: [
      {
        name: 'delivery-direct',
        service: 'carts-db',
