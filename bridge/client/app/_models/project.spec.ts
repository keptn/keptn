...
describe('Project', () => {
  it('should create instances from json', waitForAsync(() => {
    const projects: Project[] = [{
      ...
      stages: [{services: [{serviceName: 'carts'}, {serviceName: 'carts-db'}], stageName: 'dev'}, {services: [{serviceName: 'carts'}, {serviceName: 'carts-db'}], stageName: 'staging'}, {services: [{serviceName: 'carts'}, {serviceName: 'carts-db'}], stageName: 'production'}],
