...
export class KtbCreateServiceComponent implements OnDestroy {
  ...
  constructor(private route: ActivatedRoute, private dataService: DataService, private router: Router, private notificationsService: NotificationsService, private location: Location) {
